               ...
               <div class="container-fluid">
                   ...
                   <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Inventaris Barang Baik</h1>
                        <a href="<?php echo base_url("barangbaik/laporan_pdf/");?>" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"><i
                 ...
                 <?php
                    ...
                    ?>
					 <tr>
                        ...
                        <a href="<?php echo base_url('barangbaik/ubah/'.$data['id_barang']) ?>" 
