...
<head>
    ...
    <title>Laporan Mutasi Barang Keluar</title>
    <style>
        tr .spaceUnder > td {
            padding-bottom: 5em;
        }
...
<body>
    <h4 class="table-font" style="text-align: center;">DAFTAR MUTASI BARANG KELUAR<br>UPPD PELAIHARI</h4>
    ...
    <table class="table table-bordered table-striped border text-td judul-font">
        <thead>
            <tr>
                ...
                <th class="border" scope="col">Penerima Barang</th>
        ...
        <tbody>
            <?php $no = 1; foreach ($mutasikeluar as $data) { ?>
                <tr>
