...
<body>
    <h4 class="table-font" style="text-align: center;">LAPORAN INVENTARIS BARANG ALAT KANTOR DAN RUMAH TANGGA<br>KONDISI RUSAK BERAT UPPD PELAIHARI</h4>
    ...
    <table class="table table-bordered table-striped border text-td judul-font">
        ...
        <tbody>
            <?php $no = 1; foreach ($barangrusak as $data) { 
